...
class BottomAppBar2 extends StatefulWidget {
  ...
  @override
  State createState() => _BottomAppBar2State();
}
...
class _BottomAppBar2State extends State<BottomAppBar2> {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget child = SizedBox(
      height: height,
      child: Padding(
        padding: widget.padding ?? babTheme.padding ?? (isMaterial3 ? const EdgeInsets.symmetric(vertical: 6, horizontal: 30) : EdgeInsets.zero),
        child: widget.child,
      ),
    );
